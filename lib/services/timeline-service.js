...
var Service = function(params) {
  ...
  app.use('/data', params.timelineController.buildDataRouter());
  app.use('/rest', params.timelineController.buildRestRouter());

  app.use(params.timelineController.buildPageRouter());
