...
var FigureModel = require('../models/figure-model.js');
...
var Service = function(params) {
  ...
  var eventModel = EventModel(connection);
  var factModel = FactModel(connection);
  var figureModel = FigureModel(connection);
  ...
  self.buildRestRouter = function() {
    ...
    router.route('/events')
      ...
      .post(function(req, res, next) {
        var event = new eventModel(lodash.pick(req.body, pickSchema(eventModel, ['_id', '__v'])));
    ...
    router.route('/events/:id')
      ...
      .put(function(req, res, next) {
        ...
        lodash.pick(req.body, pickSchema(eventModel, ['_id', '__v'])),
        function(err, num, raw) {
          if (err) res.send(err);
          res.json({ message: num + ' updated' });
        });
    ...
    router.route('/facts')
      .get(function(req, res, next) {
        factModel.find({}, function(err, facts) {
          if (err) res.send(err);
          res.json(facts);
        });
      })
      .post(function(req, res, next) {
        var fact = new factModel(lodash.pick(req.body, pickSchema(factModel, ['_id', '__v'])));
    ...
    router.route('/facts/:id')
      .get(function(req, res, next) {
        factModel.findById(req.params.id, function(err, fact) {
          if (err) res.send(err);
          res.json(fact);
        })
      })
      .put(function(req, res, next) {
        ...
        lodash.pick(req.body, pickSchema(factModel, ['_id', '__v'])),
        function(err, num, raw) {
          if (err) res.send(err);
          res.json({ message: num + ' updated' });
        });
      ...
      .delete(function(req, res, next) {
        factModel.remove({ _id: req.params.id }, function(err) {
          if (err) res.send(err);
          res.json({ message: 'Beer removed from the locker!' });
        });
      });
    ...
    router.route('/figures')
      .get(function(req, res, next) {
        figureModel.find({}, function(err, figures) {
          if (err) res.send(err);
          res.json(figures);
        });
      })
      .post(function(req, res, next) {
        var figure = new figureModel(lodash.pick(req.body, pickSchema(figureModel, ['_id', '__v'])));
    ...
    router.route('/figures/:id')
      .get(function(req, res, next) {
        figureModel.findById(req.params.id, function(err, figure) {
          if (err) res.send(err);
          res.json(figure);
        })
      })
      .put(function(req, res, next) {
        ...
        lodash.pick(req.body, pickSchema(figureModel, ['_id', '__v'])),
        function(err, num, raw) {
          if (err) res.send(err);
          res.json({ message: num + ' updated' });
        });
      ...
      .delete(function(req, res, next) {
        figureModel.remove({ _id: req.params.id }, function(err) {
          if (err) res.send(err);
          res.json({ message: 'Beer removed from the locker!' });
        });
      });
